...
export default function AIAssistantPage() {
    ...
    const isLocked = !hasFeature('ai_content')

    return (
        <PremiumLock
            isLocked={isLocked}
            featureName="AI Assistant & Voice Agent"
            description="Unlock your own AI representative that can chat and speak with visitors."
        >
